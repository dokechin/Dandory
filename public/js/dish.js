...
steps : [
	  {name : '野菜を切る', duration : 1, content : '一口サイズに野菜を切ります', resources : ['料理人','作業台'], proportional : { b : 1 }},
	  {name : '肉野菜を炒める', dependsOn : [0], duration : 5, content : '鍋で炒める', resources : ['料理人','コンロ'], constant : true},
	  {name : '煮る', dependsOn : [1], duration : 15, content: '野菜が柔らかくなるまで煮ます', resources : ['コンロ'], constant : true },
