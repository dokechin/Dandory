var dish1 = {
  ...
  var dish2 = {
	...
	steps : [
	  ...
	  {name : '煮る', dependsOn : [0], duration : 5, content: '野菜が柔らかくなるまで煮ます', resources : ['コンロ'], constant : true},
...
steps : [
	  ...
	  {name : '煮る', dependsOn : [1], duration : 10, content: '野菜が柔らかくなるまで煮ます', resources : ['コンロ'], constant : true },
